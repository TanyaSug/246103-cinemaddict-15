...
const createSiteMenuTemplate = (siteMenuList) => {
  const {watchlistCount, historyCount, favoritesCount} = siteMenuList;
  return (
...
export default class SiteMenu {
  constructor(siteMenuList) {
    this._siteMenuList = siteMenuList;
    this._element = null;
  }

  getTemplate() {
    return createSiteMenuTemplate(this._siteMenuList);
  }
